...
local Recipes = require("__RecipeMaker").Recipes
local Recipe = require("__RecipeMaker").Recipe
...
-------------------------------------------------
Recipes.add { dispName = "Liquid Ender",
	unitInput = {
		item = {
...
-------------------------------------------------
Recipes.add { dispName = "Battery Alloy Dust",
	unitInput = {
		item = {
			[I.lead_dust] = 1,
			[I.antimony_dust] = 1,
...
-------------------------------------------------
Recipes.add { dispName = "Copper Ingot Mega",
	unitInput = {
		item = {
			[I.copper_dust] = 32
		}
